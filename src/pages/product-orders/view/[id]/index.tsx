...
import { getProductOrderById } from 'apiSdk/product-orders';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Product Order Detail View
          </Text>
          {hasAccess('product_order', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/product-orders/edit/${data?.id}`} passHref legacyBehavior>
              <Button
